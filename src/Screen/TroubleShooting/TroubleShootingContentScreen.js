...
import { uploadImage } from '../../Service/TroubleshootService';
import { useForm, Controller } from 'react-hook-form';
import Swal from 'sweetalert2';
import { useNavigate, useParams } from 'react-router-dom';
import { setTroubleshootContent } from '../../Redux/Action/TroubleshotAction';
...
const TroubleShootingContentScreen = () => {
    ...
    const { troubleshoot, troubleshoot_header, troubleshoot_content } = useSelector(({ troubleshoot }) => troubleshoot);
        ...
        switch (contentState) {
            case 'add':
                const _content = {
                    ...
                    image_name: no_image,
                    name: '',
                    step_order: (troubleshoot_content || []).length + 1,
                    is_active: true,
                };
                _content.descriptions = troubleshoot_header.map(e => ({
                    id: undefined,
            ...
            case 'edit':
            case 'view':
                const c = troubleshoot_content.find(c => c.id == contentid);
    ...
    const onSubmit = data => {
        ...
        dispatch(setTroubleshootContent(_contents));
        onGoback();
    }
                ...
                <div className="container-fluid">
                    <div className="row mb-2">
                        <div className="col-sm-6">
                            <h1 className="m-0">Manage Troubleshooting</h1>
                        </div>
                        <div className="col-sm-6">
                            <ol className="breadcrumb float-sm-right">
                                <li className="breadcrumb-item"><a href="#">Home</a></li>
                                <li className="breadcrumb-item active">Troubleshooting Content</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div className='row'>
                                    ...
                                    <div className='col-md-5'>
                                        ...
                                        <div className='form-group'>
                                            ...
                                            <textarea name='question' value={description.question} className='form-control' rows={2} onChange={onLangValChange} onBlur={onLangBlur}></textarea>
                                        </div>
                                        <div className='form-group'>
                                            <label htmlFor='solution_descriptions'>Solution</label>
                                            <textarea name='solution_descriptions' value={description.solution_descriptions} className='form-control' rows={2} onChange={onLangValChange} onBlur={onLangBlur}></textarea>
                                        </div>
