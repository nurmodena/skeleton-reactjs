...
const columns = [
    { id: 1, title: 'Sub Category Name', field: 'name', sortTable: true },
                            ...
                            <div className='card'>
                                ...
                                <div className='card-body'>
                                    <div className='form-group'>
                                        ...
                                        <input id="subcategory-name" name="subctgName" placeholder='Sub Category name' className='form-control' />
                                    </div>
                                    <div className='form-group'>
                                    ...
                                    <div className='form-group'>
                                        ...
                                        <div >
                                            <img src="https://media.web.modena.com/products/images/12/jfxj7CsSoak6etjwiNlYYj6ggqLTF73ZBKiKUSbR.png" style={{ objectFit: 'cover', width: '100%' }} alt="select image" />
                                        </div>
